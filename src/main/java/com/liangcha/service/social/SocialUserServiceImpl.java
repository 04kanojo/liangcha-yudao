package com.liangcha.service.social;

import cn.hutool.core.lang.Assert;
import com.liangcha.dao.social.SocialUserBindMapper;
import com.liangcha.dao.social.SocialUserMapper;
import com.liangcha.domain.social.SocialUserBindDO;
...
//        SocialUserDO socialUser = socialUserMapper.selectByTypeAndCodeAndState(type, code, state);
//        if (socialUser != null) {
//            return socialUser;
//        }
//
...
//        List<SocialTypeEnum> collect = Arrays.stream(SocialTypeEnum.values()).filter(o -> o.getType().equals(type)).collect(Collectors.toList());
//        if (collect.size() == 0) {
//            throw new ServiceException(ErrorCodeEnum.ERROR_CODE_NOT_EXISTS);
//        }
//        //如果找到了,实际枚举类里面只找得到一个
//        SocialTypeEnum so = collect.get(0);
//        AuthRequest authRequest = yudaoAuthRequestFactory.get(so.getSource());
