package com.liangcha.service.user;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.liangcha.dao.user.AdminUserMapper;
...
//        // 校验正确性
//        validateUserForCreateOrUpdate(reqVO.getId(), reqVO.getUsername(), reqVO.getMobile(), reqVO.getEmail(), reqVO.getDeptId(), reqVO.getPostIds());
//        // 更新用户
...
//        }
//        Set<Long> deptIds = convertSet(deptService.getDeptListByParentIdFromCache(deptId, true), DeptDO::getId);
