    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="120px">
      ...
      <el-form-item label="退款渠道" prop="channelCode">
        <el-select v-model="queryParams.channelCode" placeholder="请选择退款渠道" clearable>
          <el-option v-for="dict in this.getDictDatas(DICT_TYPE.PAY_CHANNEL_CODE)" :key="dict.value" :label="dict.label"
                     :value="dict.value"/>
        </el-select>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="退款订单号" align="left" width="300">
        <template v-slot="scope">
          ...
          <p class="order-font">
            <el-tag size="mini" type="warning">退款</el-tag>
            {{scope.row.no}}
          </p>
    ...
    <el-dialog title="退款订单详情" :visible.sync="open" width="700px" v-dialogDrag append-to-body>
      <el-descriptions :column="2" label-class-name="desc-label">
        ...
        <el-descriptions-item label="渠道退款单号">
          <el-tag type="success" size="small" v-if="refundDetail.channelRefundNo">{{ refundDetail.channelRefundNo }}
          </el-tag>
        </el-descriptions-item>
      </el-descriptions>
      <el-descriptions :column="2" label-class-name="desc-label">
